 ...
 */
router.post('/verify-otp', authValidation_1.default.verifyOTP, authController_1.default.verifyOTP);
/**
 * @swagger
 * /auth/login:
 *   post:
 ...
 *                   example: Internal server error
 */
router.put('/refresh-token', authValidation_1.default.refreshToken, authController_1.default.refreshToken);
/**
 * @swagger
 * /auth/logout:
 *   put:
 ...
 *                   example: Internal server error
 */
router.put('/logout', authValidation_1.default.logout, authController_1.default.logout);
/**
 * @swagger
 * /auth/get-profile:
 *   get:
 ...
 *                   example: Internal server error
 */
router.get('/get-profile', authController_1.default.getProfile);
